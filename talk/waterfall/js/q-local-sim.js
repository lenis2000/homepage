            ...
            window.slideEngine.registerSimulation('q-local', {
                ...
                async onStep(step) {
                    ...
                    if (step === 1) {
                        ...
                        insightEl.innerHTML = '<strong style="color: #c00; font-size: 1.2em;">Local universality BROKEN at extreme q!</strong><br>When q is too extreme (q = 0.67), the path becomes a finite (random) perturbation of the deterministic path that hugs the corner. In other words, the configuration is <strong>frozen</strong>.';
                        insightEl.style.opacity = '1';
                        draw();

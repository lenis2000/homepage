            ...
            window.slideEngine.registerSimulation('q-local', {
                ...
                async onStep(step) {
                    ...
                    if (step === 1) {
                        ...
                        insightEl.innerHTML = '<strong style="color: #c00; font-size: 1.2em;">Universality BROKEN at extreme q!</strong><br>When q is too extreme (q = 0.67), the path becomes deterministic—always hugs the corner.';
                        insightEl.style.opacity = '1';
                        draw();

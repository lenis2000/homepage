/*
emcc triangle-lozenge.cpp -o triangle-lozenge.js \
  -s WASM=1 \
  -s MODULARIZE=1 \
  -s "EXPORT_NAME='TriangleLozenge'" \
  -s "EXPORTED_FUNCTIONS=['_initFromTriangles','_performGlauberSteps','_exportDimers','_setQBias','_getQBias','_setHoleBaseHeight','_getHoleCount','_getAllHolesInfo','_adjustHoleWindingExport','_freeString','_initCFTP','_stepCFTP','_finalizeCFTP','_malloc','_free']" \
...
// ============================================================================
// CFTP (Coupling From The Past) - Step-by-step version
// ============================================================================

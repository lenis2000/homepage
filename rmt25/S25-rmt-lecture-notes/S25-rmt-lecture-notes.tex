...
\chapter[Moments]{Moments of random variables and random
matrices}
\label{chap:lecture1}
...
\subsection{Ensemble \texorpdfstring{$UD_\lambda U^\dagger$}{with fixed eigenvalues}}
...
\subsection{Counting \texorpdfstring{$n$}{n}-powers in the real Wigner matrix}
...
\subsubsection{Tightness \texorpdfstring{of \(\{\nu_n\}\)}{} and subsequential limits}
...
\section{Proof \texorpdfstring{of \Cref{lecture2:prop:variance-bound}}{}: bounding the variance}
...
\chapter[Semicircle law]{Semicircle law for G$\beta$E via tridiagonalization. Beginning determiantal processes}
\label{chap:lecture4}
...
\chapter[GUE as determinantal process]{Determinantal Point Processes and the GUE}
\label{chap:lecture5}
...
\chapter[Integrals and steepest descent]{Double contour integral kernel. Steepest descent and semicircle law}
\label{chap:lecture6}
...
\chapter[Local statistics and corners]{Steepest descent and local statistics. Cutting corners}
\label{chap:lecture7}
...
\subsection{Case \texorpdfstring{$\beta=\infty$}{of infinite beta}}
...
\subsection{Proof \texorpdfstring{of \Cref{lecture8:Theorem_loop_equation}}{} for $\beta>2$}
...
\subsection{Jacobian from \texorpdfstring{$n-1$}{n-1} to \texorpdfstring{$n$}{n} dependent variables}
...
\chapter[Loop equations and GFF]{Loop equations and asymptotics to Gaussian Free Field}
\label{chap:lecture9}
...
\chapter[Asymptotics of Dyson BM]{Asymptotics of Dyson Brownian Motion with an outlier}
...
are governed by the Gaussian Free Field (GFF), which we encountered earlier in \Cref{chap:lecture9}.
...
\chapter[Random Growth I]{Matching Random Matrices to Random Growth I}
...
\chapter[Random Growth II]{Matching Random Matrices to Random Growth II}

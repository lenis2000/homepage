...
\begin{proof}[Proof of \Cref{lemma:moments_convergence}]
	...
	we must get a \emph{tree}, with $k/2$ edges.
	This implies that the combinatorial
	factor is equal to $\sigma^k$ times the
	number of \emph{rooted trees} with $k/2$ edges.

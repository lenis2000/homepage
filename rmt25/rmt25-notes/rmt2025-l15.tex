...
mixed covariances vanish and Wick’s formula factorises:
\begin{equation}
  \bigl\langle
...
\end{equation}
The general case follows from the diagonal case by
making a linear change of variables which diagonalizes the covariance matrix, and
proving \eqref{eq:wick}.
\end{proof}
...
\colorbox{yellow}{\parbox{.7\textwidth}{to continue here}}

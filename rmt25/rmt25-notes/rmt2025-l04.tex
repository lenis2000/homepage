...
See \Cref{fig:motzkin} for an illustration of a Motzkin path.
...
\begin{figure}[htb]
 \begin{center}
  \begin{tikzpicture}[scale=0.7]
   ...
   \draw[ultra thick,blue] (0,0) -- (1,1) -- (2,2) -- (3,2) -- (4,1) -- (5,1) -- (6,0) -- (7,0) -- (8,0);
   \foreach \x/\y in {0/0,1/1,2/2,3/2,4/1,5/1,6/0,7/0,8/0} {

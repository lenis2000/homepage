\documentclass[letterpaper,11pt,twoside,reqno]{book}
...
\chapter{Lecture 1: Moments of random variables and random
matrices}
\label{chap:lecture1}
...
\chapter{Lecture 2: Wigner semicircle law}
\label{chap:lecture2}
...
\chapter{Lecture 3: Gaussian and tridiagonal matrices}
\label{chap:lecture3}
...
\chapter{Lecture 4: Semicircle law for G$\beta$E via tridiagonalization. Beginning determiantal processes}
\label{chap:lecture4}
...
\begin{equation}
  ...
  \text{for each $k\ge1$}.
\end{equation}
The simplest example is the \emph{Poisson process} (see \Cref{subsec:poisson-example}).
...
\chapter{Lecture 5: Determinantal Point Processes and the GUE}
\label{chap:lecture5}
...
\chapter{Lecture 6: Double contour integral kernel. Steepest descent and semicircle law}
\label{chap:lecture6}
...
\chapter{Lecture 7: Steepest descent and local statistics. Cutting corners}
\label{chap:lecture7}
...
\chapter{Lecture 8: Cutting corners and loop equations}
\label{chap:lecture8}
...
\chapter{Lecture 9: Loop equations and asymptotics to Gaussian Free Field}
\label{chap:lecture9}
...
\chapter{Lecture 10: Dyson Brownian Motion}
...
\chapter{Lecture 11: Asymptotics of Dyson Brownian Motion with an outlier}
...
\chapter{Lecture 15: Random matrices and topology}

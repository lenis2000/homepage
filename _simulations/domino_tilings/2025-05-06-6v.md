...
published: false
a11y-description: "Displays a domino tiling of the Aztec diamond rotated 45 degrees, with overlaid nonintersecting lattice paths showing the bijection to the six-vertex model. Four domino colors encode orientations. Controls set the diamond size and toggle color and path overlays."
---
...
<div class="row">
  <div class="col-12">
    <svg id="aztec-svg" role="img" aria-label="Aztec diamond domino tiling with six-vertex model path overlay"></svg>
  </div>
</div>

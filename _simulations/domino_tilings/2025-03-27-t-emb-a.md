...
An illustration of the T-embedding of an Aztec diamond graph, together with the origami map, allowing a tunable scale factor \(a\).
...
<div id="controls" style="font-size: 20px;">
  ...
  <label for="a-input" style="margin-left: 15px;">Scale factor a:</label>
...
Module.onRuntimeInitialized = async function() {
  ...
  function handleUpdate() {
    ...
    if (aVal <= 0) {
      alert("Scale factor a must be positive.");
      return;
    }

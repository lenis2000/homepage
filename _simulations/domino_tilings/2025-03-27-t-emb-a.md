...
a11y-description: "Interactive visualization of the t-embedding and origami map of an Aztec diamond graph. A tunable scale parameter controls the embedding geometry. The tiling is displayed as an SVG with draggable view."
---

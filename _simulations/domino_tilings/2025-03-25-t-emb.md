...
<div id="controls" style="font-size: 20px;">
  ...
  <input id="n-input" type="number" value="10" min="0" max="200" step="1">
...
Module.onRuntimeInitialized = async function() {
  ...
  function handleUpdate() {
    ...
    setTimeout(() => {
      ...
      updateVisualization(nVal, progressInterval).finally(() => {
  ...
  // Trigger update automatically when the page loads

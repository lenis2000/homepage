...
a11y-description: "Interactive 3D surface showing the t-embedding of an Aztec diamond graph with doubly periodic weights. Height is given by the origami map imaginary part. Adjust diamond size n and weight parameter a; orbit, pan, and zoom the 3D view with mouse or arrow keys. Demo mode auto-rotates."
---
...
<div style="margin-bottom: 1em; font-size: 18px;">
  ...
  <div id="progress-container" style="margin-top: 10px; display: none;">
    <div style="display: flex; align-items: center;">
      ...
      <div id="progress-text" style="margin-left: 10px;" role="status" aria-live="polite">0%</div>
    </div>
  </div>
  ...
  <input id="label-scale" type="range" min="1" max="70" step="1" value="30" style="width: 100px; vertical-align: middle;" aria-label="Vertex label size">
  <div style="margin-top: 10px;">
      <label>Camera movement:</label>
      <button id="move-left-btn" style="padding: 2px 8px; margin: 0 5px; font-size: 14px; vertical-align: middle;" aria-label="Move camera left">←</button>
      <button id="move-up-btn" style="padding: 2px 8px; margin: 0 5px; font-size: 14px; vertical-align: middle;" aria-label="Move camera up">↑</button>
      <button id="move-down-btn" style="padding: 2px 8px; margin: 0 5px; font-size: 14px; vertical-align: middle;" aria-label="Move camera down">↓</button>
      <button id="move-right-btn" style="padding: 2px 8px; margin: 0 5px; font-size: 14px; vertical-align: middle;" aria-label="Move camera right">→</button>
      <button id="reset-view-btn" style="padding: 2px 8px; margin: 0 5px; font-size: 14px; vertical-align: middle;">Reset View</button>
  </div>
</div>

<!-- Container for the 3D canvas -->
<div id="three-container" style="width: 100%; height: 80vh;" role="img" aria-label="3D origami surface of the t-embedding of an Aztec diamond"></div>
...
<ul>
    <li>
      ...
      <a href="https://doi.org/10.1093/imrn/rnad299" target="_blank">DOI:10.1093/imrn/rnad299<span class="sr-only"> (opens in new tab)</span></a>
    </li>
    <li>
      ...
      <a href="https://arxiv.org/abs/2109.06272" target="_blank">arXiv:2109.06272<span class="sr-only"> (opens in new tab)</span></a>
    </li>
    <li>
      ...
      <a href="https://arxiv.org/abs/2002.07540" target="_blank">arXiv:2002.07540<span class="sr-only"> (opens in new tab)</span></a>
    </li>
</ul>

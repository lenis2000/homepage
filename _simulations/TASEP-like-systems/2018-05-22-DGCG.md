...
- title: 'K. Johansson. Shape fluctuations and random matrices. Communications in Mathematical Physics <strong>209</strong> (2000) no. 2, 437--476'
  arxiv-url: 'https://arxiv.org/abs/math/9903134'
  journal-url: 'https://link.springer.com/article/10.1007/s002200050027'
a11y-description: "Simulation of the doubly geometric corner growth model, a discrete-time stochastic growth process with two parameters. The visualization shows the growing interface and its cubic limit curve, with fluctuation analysis."
---
...
<img src="{{site.storage_url}}/simulations/2018-05-28-DGCG/DGCG.png" alt="Diagram of one possible time step in doubly geometric corner growth, showing box addition with truncated geometric distribution" style="min-width:30%">

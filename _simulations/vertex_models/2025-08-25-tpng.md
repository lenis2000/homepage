...
<div class="container" style="max-width: 1200px;">
  <div class="row">
    <div class="col-md-12">
      ...
      <a href="#tpng-canvas" class="skip-link">Skip to simulation canvas</a>

      <div class="simulation-container">
        <canvas id="tpng-canvas" width="700" height="700" style="border: 1px solid #ccc;" role="img" aria-label="Discretized t-PNG grid visualization showing occupied and empty cells on the integer quadrant"></canvas>
      </div>
      ...
      <div class="row mt-3">
        ...
        <div class="col-md-3">
          ...
          <div class="form-group">
            ...
            <span id="size-value" role="status" aria-live="polite">20</span>
          </div>
          <div class="form-group">

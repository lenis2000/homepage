...
model: vertex-models
author: Leo Petrov
a11y-description: "Interactive simulation of discretized t-PNG, also known as stochastic rule 54, on the positive integer quadrant. Boundary rays from both axes interact via crossing and annihilation rules controlled by birth rate and crossing probability parameters."
---

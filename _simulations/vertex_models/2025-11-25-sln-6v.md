...
a11y-description: "Interactive simulation of the stochastic colored six-vertex model on a square lattice. The model evolves via local stochastic update rules and the visualization shows the lattice configuration on a canvas."
---

...
<div class="interface-container">
  <div class="control-group">
    ...
    <div id="status" class="status-display" style="display: none;" role="status" aria-live="polite"></div>
  </div>
  ...
  <div class="control-group">
    ...
    <div class="slider-row">
      ...
      <span id="color-nonlinearity-value" role="status" aria-live="polite">20%</span>
    </div>
  </div>
  ...
  <div class="control-group">
    ...
    <div class="export-group">
      ...
      <div class="quality-slider">
        ...
        <span id="png-quality-value" role="status" aria-live="polite">85% (517 DPI)</span>
      </div>
    </div>
  ...
  <a href="#sln-canvas" class="skip-link">Skip to simulation canvas</a>
  <div class="full-width">
    <canvas id="sln-canvas" width="800" height="800" role="img" aria-label="Stochastic colored six-vertex model path visualization"></canvas>
  </div>
</div>
...
<div class="description mt-4">
  <h4>Description</h4>
  <p>
    The <strong>stochastic colored six-vertex model</strong> is an 𝔰𝔩<sub>n+1</sub>-related integrable stochastic system
  ...
  <ul>
    <li>When <strong>bottom color &gt; left color</strong>: paths cross with probability 1−b<sub>2</sub>, or go straight with probability b<sub>2</sub></li>
    <li>When <strong>bottom color &lt; left color</strong>: paths go straight with probability b<sub>1</sub>, or cross with probability 1−b<sub>1</sub></li>
    <li>When <strong>colors are equal</strong>: paths continue straight (deterministic)</li>
  </ul>
  <p>
    The boundary conditions place paths with colors 0, 1, 2, ..., N−1 entering from the left boundary
    at heights 0, 1, 2, ..., N−1, respectively. The rainbow coloring visualizes how these colored paths
  ...
  <ul>
    <li>
      A. Borodin, M. Wheeler,
      <a href="https://arxiv.org/abs/1808.01866" target="_blank"><i>Coloured stochastic vertex models and their spectral theory</i><span class="sr-only"> (opens in new tab)</span></a>,

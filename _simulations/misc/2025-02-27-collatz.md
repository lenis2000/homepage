...
a11y-description: "Interactive line chart of Collatz sequence values for a user-chosen starting integer. The famous 3n+1 conjecture is explored by iterating even-halving and odd-tripling rules. Enter a number, view the step graph, sequence length, highest value, and full sequence path to 1."
---
  ...
  <div class="row mt-4">
            ...
            <div class="mb-3">
              ...
              <div class="number-input-container">
                ...
                <div class="number-controls">
                  <span class="number-control-btn" id="increment-btn" role="button" aria-label="Increment starting number">▲</span>
                  <span class="number-control-btn" id="decrement-btn" role="button" aria-label="Decrement starting number">▼</span>
                </div>
              </div>
            </div>
      ...
      <div class="card stats-card">
        ...
        <div class="card-body">
          <div id="stats-container">
            <p><strong>Sequence Length:</strong> <span id="sequence-length" role="status" aria-live="polite">-</span></p>
            <p><strong>Highest Value:</strong> <span id="highest-value" role="status" aria-live="polite">-</span></p>
            <p><strong>Steps to Reach 1:</strong> <span id="steps-to-one" role="status" aria-live="polite">-</span></p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-8">
      <div class="card">
        ...
        <div class="card-body">
          <div class="chart-container" id="chart-container" role="img" aria-label="Line chart of Collatz sequence values versus step number"></div>
        </div>
      </div>

...
a11y-description: "Interactive visualization of Collatz sequences. Enter any positive integer and watch the sequence iterate: dividing even numbers by two and tripling odd numbers plus one. The visualization shows the sequence values, total length, and a step graph."
---

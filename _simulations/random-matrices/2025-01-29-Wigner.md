...
<div class="row">
  ...
  <div class="col-12 col-lg-8">
    <div class="controls mb-3">
      ...
      <input id="nInput" type="range" min="2" max="2000" step="1" value="50" aria-label="Matrix size N" />
      <span id="nValue" role="status" aria-live="polite">50</span>&nbsp;&nbsp;

      <!-- Distribution selector -->
      <label for="distributionSelect">Distribution:</label>
      <select id="distributionSelect" class="form-select" style="width:auto; display:inline-block;" aria-label="Entry distribution type">
...
<div class="row align-items-center">
  ...
  <div class="col-12 col-lg-6" style="min-height: 400px;">
      ...
      <div id="heatmap" role="img" aria-label="Color heatmap of random matrix entries" style="margin-top: 1rem;"></div>
  </div>
</div>

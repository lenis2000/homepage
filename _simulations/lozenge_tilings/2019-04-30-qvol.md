...
results:
  ...
  - title: Movie, size 10, all frames
    params: |
      Hexagon $10\times 10\times 10$, $q=0.85$. 
      If the video does not play in your browser, try a Chrome-based browser, or download the video and open it in e.g. VLC
    image: __STORAGE_URL__/simulations/2019-05-qvol/qvol_085_10.mp4
  ...
  - title: Movie, size 25, all frames. Almost frozen configuration
    params: |
      ...
      If the video does not play in your browser, try a Chrome-based browser, or download the video and open it in e.g. VLC
    image: __STORAGE_URL__/simulations/2019-05-qvol/qvol_07_25.mp4
  ...
  - title: Movie, size 50, only frames after each sweep
    params: |
      ...
      If the video does not play in your browser, try a Chrome-based browser, or download the video and open it in e.g. VLC
    image: __STORAGE_URL__/simulations/2019-05-qvol/qvol_095_50_macro.mp4
  ...
  - title: Movie, size 100, only frames after each sweep
    params: |
      ...
      If the video does not play in your browser, try a Chrome-based browser, or download the video and open it in e.g. VLC
    image: __STORAGE_URL__/simulations/2019-05-qvol/qvol_095_100_macro.mp4

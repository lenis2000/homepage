...
a11y-description: "Simulation of random dynamics on q-volume weighted lozenge tilings that invert the parameter q. Based on Yang-Baxter bijectivisation, vertical lozenges move left to convert the measure. Movies show the evolution on hexagons up to size 100."
---
...
<img src="{{site.storage_url}}/simulations/2019-05-qvol/qvol_095_50_begin.png" alt="Lozenge tiling of a 50x50x50 hexagon under q-volume measure at the start of Glauber dynamics, showing frozen corners" style="width:50%;min-width:500px">

<img src="{{site.storage_url}}/simulations/2019-05-qvol/qvol_095_50_middle.png" alt="Lozenge tiling midway through q-volume Glauber dynamics, with partially mixed frozen and disordered regions" style="width:50%;min-width:500px">

<img src="{{site.storage_url}}/simulations/2019-05-qvol/qvol_095_50_end.png" alt="Lozenge tiling at the end of q-volume Glauber dynamics, showing the q-volume limit shape" style="width:50%;min-width:500px">

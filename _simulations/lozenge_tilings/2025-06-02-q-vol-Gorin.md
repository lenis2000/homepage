...
<details id="animation-controls-details" class="full-width">
  ...
  <div class="content control-group-content">
    <div class="button-row">
      ...
      <input id="steps" type="number" value="1" min="1" max="9999" style="width: 60px;" aria-label="Step size r">
    ...
    <details class="nested-control-group" id="styling-controls-details">
      ...
      <div class="content">
        ...
        <div class="button-row">
          ...
          <input id="border-width" type="number" value="0.01" step="0.001" min="0" max="0.2" style="width: 100px;" aria-label="Border width">
      ...
      <div id="custom-colors-panel" class="custom-colors-panel">
        ...
        <div class="color-palette">
          ...
          <input type="color" id="color-gray1" value="#E57200" aria-label="Up rhombi color picker">
          <input type="text" id="hex-gray1" value="#E57200" placeholder="#RRGGBB" aria-label="Up rhombi hex color">
        </div>

        <div class="color-palette">
          <label>Down Rhombi:</label>
          <input type="color" id="color-gray2" value="#232D4B" aria-label="Down rhombi color picker">
          <input type="text" id="hex-gray2" value="#232D4B" placeholder="#RRGGBB" aria-label="Down rhombi hex color">
        </div>

        <div class="color-palette">
          <label>Horizontal:</label>
          <input type="color" id="color-gray3" value="#F9DCBF" aria-label="Horizontal rhombi color picker">
          <input type="text" id="hex-gray3" value="#F9DCBF" placeholder="#RRGGBB" aria-label="Horizontal rhombi hex color">
        </div>

        <div class="color-palette">
          <label>Border:</label>
          <input type="color" id="color-border" value="#666666" aria-label="Border color picker">
          <input type="text" id="hex-border" value="#666666" placeholder="#RRGGBB" aria-label="Border hex color">
        </div>
...
<canvas id="lozenge-canvas" role="img" aria-label="Lozenge tiling visualization of hexagonal region under q-volume measure"></canvas>

/*
emcc 2025-06-03-q-vol-mirroring.cpp -o 2025-06-03-q-vol-mirroring.js \
 -s WASM=1 \
 -s ASYNCIFY=1 \
 ...
 -s SINGLE_FILE=1 \
 -O3 -ffast-math
  mv 2025-06-03-q-vol-mirroring.js ../../js/

Features:
- Lozenge tilings simulation (WASM/JS port of Vadim Gorin's program)
- Mirroring algorithm for q-volume lozenge tilings

...
Module.onRuntimeInitialized = async function() {
    ...
    async function initializeTiling() {
        ...
        if (imaginaryMode) {
            const kappaI = parseFloat(document.getElementById('kappa-i').value) || 1.0;
            // In imaginary q-Racah mode, we pass kappa/i directly as q parameter
            q = kappaI;
...
`;
    ...
    function setupEventListeners() {
        ...
        document.getElementById('set-parameters')?.addEventListener('click', async () => {
            try {
                ...
                if (imaginaryMode) {
                    ...
                    // Encode kappasq as negative q (WASM interface limitation)
                    // The C++ code will decode this and use imaginaryQ as the actual q parameter
                    q = -kappasq;
                    mode = 7; // Use IMAGINARY_Q_RACAH mode
                }
        ...
        document.getElementById('imaginary-q-racah')?.addEventListener('change', (e) => {
            ...
            if (e.target.checked) {
                // Show kappa parameter when checkbox is checked
                ...
                // Hide kappa parameter when checkbox is unchecked

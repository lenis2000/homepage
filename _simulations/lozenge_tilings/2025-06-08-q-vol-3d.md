...
Module.onRuntimeInitialized = async function() {
    ...
    class Tiling3DVisualizer {
        ...
        pathsTo3D(paths, N, T, S) {
            ...
            for (let pathIdx = 0; pathIdx < allPaths.length; pathIdx++) {
                ...
                if (pathIdx === 0) {
                    pathColor = '#FF0000'; // Red for top boundary
                } else if (pathIdx === allPaths.length - 1) {
                    pathColor = '#0000FF'; // Blue for bottom boundary
                } else {
                    pathColor = '#00FF00'; // Green for middle paths
                }
            ...
            for (let pathIdx = 0; pathIdx < allPaths.length - 1; pathIdx++) {
                ...
                console.log(`Upper path:`, upperPath);
                console.log(`Lower path:`, lowerPath);
    ...
    async function initializeTiling() {
        ...
        const S = parseInt(document.getElementById('S').value) || 5;

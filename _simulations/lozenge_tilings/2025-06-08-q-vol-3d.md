  ...
  <div class="content">
    ...
    <details class="nested-control-group">
      ...
      <div class="content">
        ...
        <div class="button-row" style="margin-top: 8px;">
          <label for="png-quality">PNG Quality (DPI):</label>
          <input type="range" id="png-quality" min="0" max="100" value="100" style="width: 100px;">
          <span id="png-quality-value">100</span>
        </div>

...
<details class="info-section-details" id="config-details">
  ...
  <div class="content">
    <div class="config-values" id="info">
      <span class="config-item">N = <strong>4</strong></span>
      <span class="config-item">T = <strong>10</strong></span>
      <span class="config-item">S = <strong>0</strong></span>
    ...
    function setupEventListeners() {
        ...
        document.getElementById('set-parameters')?.addEventListener('click', async () => {
            try {
                ...
                alert('Parameter update failed: ' + error.message);
            }
        });

      ...
      <div class="content">
        ...
        <div class="parameters-grid" style="margin-top: 12px;">
          ...
          <div class="param-item">
            ...
            <input type="number" id="cam-distance" value="50" min="1" step="5" style="width: 60px;">
          </div>
        </div>
...
Module.onRuntimeInitialized = async function() {
    ...
    class Tiling3DVisualizer {
        ...
        centerCamera(maxX, maxY, maxZ) {
            ...
            // Position camera from the left for good view (6x closer zoom)
            const distance = Math.max(maxX, maxY, maxZ) * 1 / 3;  // 6x zoom
    ...
    function setupEventListeners() {
        ...
        document.getElementById('set-parameters')?.addEventListener('click', async () => {
            try {
                ...
                const S = parseInt(document.getElementById('S').value) || 0;
                const q = parseFloat(document.getElementById('q').value) || 1.0;
                const mode = parseInt(document.getElementById('style').value) || 1;
                ...
                if (tilingVisualizer) {
                    tilingVisualizer.setStyle(mode);
                }

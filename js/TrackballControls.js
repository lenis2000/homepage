( function () {
	...
	// TrackballControls allows free rotation without a fixed "up" direction.
	// Based on Three.js r128 TrackballControls addon.
				...
				return function panCamera() {
					...
					if ( mouseChange.lengthSq() ) {
						...
						if ( scope.object.isOrthographicCamera ) {
							...
							const scale_x = ( scope.object.right - scope.object.left ) / scope.object.zoom / scope.screen.width;
							const scale_y = ( scope.object.top - scope.object.bottom ) / scope.object.zoom / scope.screen.height;

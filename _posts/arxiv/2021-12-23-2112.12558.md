...
published: true
---
{% raw %}We establish analogues of the geometric Pitman $2M-X$ theorem of Matsumoto and Yor and of the classical Dufresne identity, for a multiplicative random walk on positive definite matrices with Beta type II distributed increments. The Dufresne type identity provides another example of a stochastic matrix recursion, as considered by Chamayou and Letac (J. Theoret. Probab. 12, 1999), that admits an explicit solution.{% endraw %}

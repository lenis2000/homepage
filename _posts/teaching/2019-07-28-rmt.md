...
The class meets on Tuesdays and Thursdays at TBA in TBA

Office hours TBA. Office is Kerchof 209
...
The homework will be assigned in the course notes (look for bright
green pencil sings). The deadline for each problem is 2.5 or 3 weeks,
which means:
- if a problem relates to a lecture on Tuesday in week $n$, then it is
		due on Thursday on week $n+2$ (but no later than the official
		final exam
		date for the course);

...
image-alt: Inhomogeneous two-dimensional discrete sine kernel
pdf-size: 8.9 MB
---

Discusses symmetric functions and stochastic models based on the free fermionic six vertex model. Follows [joint work with Aggarwal, Borodin, and Wheeler][ref38].
